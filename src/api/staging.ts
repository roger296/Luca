...
stagingRouter.get('/', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
stagingRouter.post('/:id/approve', async (req: Request, res: Response, next: NextFunction) => {
  try {
...
stagingRouter.post('/:id/reject', async (req: Request, res: Response, next: NextFunction) => {
  try {
    const { id } = req.params as { id: string };
